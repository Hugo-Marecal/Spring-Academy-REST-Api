...
class CashCardsApplicationTests {
	...
	@Test
	void shouldReturnASortedPageOfCashCardsWithNoParametersAndUseDefaultsValues() {
		ResponseEntity<String> response = restTemplate
				.withBasicAuth("sarah1", "abc123")
				.getForEntity("/cashcards", String.class);
		assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
	...
	void shouldNotUpdateACashCardThatDoesNotExist() {
		CashCard unknowCard = new CashCard(null, 19.99, null);
		HttpEntity<CashCard> request = new HttpEntity<>(unknowCard);
		ResponseEntity<Void> response = restTemplate
				.withBasicAuth("sarah1", "abc123")
